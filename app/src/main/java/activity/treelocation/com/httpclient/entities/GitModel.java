...
public class GitModel {
     ...
     * updated_at : 2016-08-08T19:43:55Z
     */
    ...
    public static GitModel objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new com.google.gson.Gson().fromJson(jsonObject.getString(str), GitModel.class);
